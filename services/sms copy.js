/**
 * SMS Service - Using Official Africa's Talking SDK
 * Handles SMS notifications via Africa's Talking
 */
...
class SMSService {
  ...
  async send(phone, message) {
    try {
      ...
      // Check if response has SMSMessageData
   ...
   * @returns {Promise<Object>} Send result
   */
 //s async sendVoucherCode(phoneNumber, code, amount, currency, senderName) {
